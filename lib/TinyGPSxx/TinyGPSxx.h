...
#ifndef __TinyGPSPlusx_h
#define __TinyGPSPlusx_h
...
public:
  ...
  uint32_t passedChecksum()   const { return passedChecksumCount; }
   ...
   // by JG
   uint8_t cFixMode() {return sentenceFixStatus;}
...
private:
  ...
  bool sentenceHasFix;
  uint8_t sentenceFixStatus; // 0=none, 1=2d/3d-fix, 2=RTK-diff., 5=RTK-Float, 4=RTK-Fix
